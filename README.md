...
In order to test the Chrome extension:
	-Download the github code and extract the chrome extension folder.
	-In chrome's extension manager, enable developer mode.
	-Then, click "Load unpacked" and navigate inside the chrome extension folder and click select folder.
	-After this, make sure the extension is turned on, and open up sample.html from the same folder in chrome.
	-You should be able to see the text automatically changing.
